...
# 加载数据
behaviors_df = pd.read_csv('/Users/halllo/projects/local/low-resource-lang-jailbreak/data/advbench/harmful_behaviors.csv')
strings_df = pd.read_csv('/Users/halllo/projects/local/low-resource-lang-jailbreak/data/advbench/harmful_strings.csv')
...
# CSV输出文件
output_csv = '/Users/halllo/projects/local/low-resource-lang-jailbreak/data/processed/advbench_input.csv'
...
with open(output_csv, 'w', encoding='utf-8', newline='') as csvfile:
    ...
    for instruction in harmful_instructions:
        ...
        for lang in langs:
            ...
            try:
                target_text = translator.Translate(source_text, source_lang_code, target_lang_code)
